...
class BTLeafNode {
  public:
void printNode(); //DEBUG
	BTLeafNode(){*((int*)buffer) = 0; *((int*)(buffer + PageFile::PAGE_SIZE - sizeof(PageId))) = -1;};
...
class BTNonLeafNode {
  public:
void printNode(); //DEBUG
BTNonLeafNode(){*((int*)buffer) = 0; *((int*)(buffer + PageFile::PAGE_SIZE - sizeof(PageId))) = -1;};
